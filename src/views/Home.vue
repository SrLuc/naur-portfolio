  ...
  >
      ...
      >
        ...
        >
          ...
          <p class="mb-6 text-gray-300 leading-relaxed">
            ...
            <br>
            Dive into my About Me section to discover the journey, passion,
            and vision that drive my work.
          </p>
    ...
    <main class="z-10 flex flex-col items-center justify-center p-4">
      ...
      <p class="text-gray-300 text-lg md:text-xl">
        Visit my <a href="/blogs" class="underline text-cyan-400 hover:opacity-80">blog</a>
        for thoughts on tech and volunteering, and also check out my
        <a target="_blank" href="https://vsco.co/rickelmeramos/gallery" class="underline text-cyan-400 hover:opacity-80">gallery</a>
