<template>
  <div class="container">
    ...
    <div class="back-top-wrapper">
      ...
      <div class="buttons">
        <a href="https://smart-fit-challenger.vercel.app/" target="_blank">
          <button class="demo-button">See Demo</button>
        </a>
    ...
    <div class="project-article">
      ...
      <div class="card">
        ...
        <p>
          Development of a
          <strong>responsive Smart Fit location finder</strong> with advanced
          filtering capabilities, real-time status display, and optimized user
          experience. <br />Built with modern frontend technologies and
          following best practices for performance and maintainability.
        </p>
      </div>

      <!-- Images Card with Masonry -->
      <div class="card">
        <h2>Project Screenshots</h2>
        <div class="masonry">
          <img
            src="../../../public/assets/1.smartfit/fit (2).png"
            alt="Smart Fit Map View"
          />
          <img
            src="../../../public/assets/1.smartfit/fit (3).png"
            alt="Smart Fit Map View"
          />
          <img
            src="../../../public/assets/1.smartfit/fit (4).gif"
            alt="Smart Fit Map View"
          />
        </div>
      </div>
      ...
      <div class="card">
        ...
        <ul>
          <li>
            <strong>Location Search:</strong> Find Smart Fit units with
            comprehensive filtering options.
          </li>
          <li>
            <strong>Real-time Status:</strong> Display open/closed status and
            operating hours.
          </li>
          <li>
            <strong>Responsive Design:</strong> Fully optimized for desktop and
            mobile devices.
          </li>
          <li>
            <strong>Performance Optimized:</strong> Fast loading and smooth user
            interactions.
          </li>
          <li class="tech-stack">
        ...
        <ul>
          ...
          <li>
            Access the application on any device with internet connection.
          </li>
        </ul>
      </div>
    </div>
